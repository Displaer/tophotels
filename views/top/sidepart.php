                    ...
                    <div class="side-nav">
                        <ul class="side-nav-ul">
                            ...
                            <li class="side-nav-li">
                                <a href="help-selection#my-profile" class="side-nav-li-a  side-nav-li-a--del-arr js-left-menu-1023-anchor ">Мой
                                    профиль</a>
                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#catalog" class="side-nav-li-a side-nav-li-a--del-arr js-left-menu-1023-anchor  ">Каталог
                                    отелей</a>
                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#club-tx" class="side-nav-li-a  side-nav-li-a--del-arr  js-left-menu-1023-anchor">Клуб
                                    ТопХотелс</a>
                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#help-selection"
                                   class="side-nav-li-a  side-nav-li-a--del-arr js-left-menu-1023-anchor ">Помощь в
                                    подборе</a>
                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#add-review" class="side-nav-li-a  side-nav-li-a--del-arr  js-left-menu-1023-anchor">Добавить
                                    отзыв</a>
                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#features" class="side-nav-li-a  side-nav-li-a--del-arr  js-left-menu-1023-anchor">О
                                    проекте</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="left-menu-1023__item">
                    ...
                    <div class="side-nav">
                        ...
                        <ul class="side-nav-ul">
                            ...
                            <li class="side-nav-li">
                                <a href="help-selection#" class="side-nav-li-a grey">Конкурсы и игры</a>
                        ...
                        <ul class="side-nav-ul">
                            ...
                            <li class="side-nav-li">
                                <a href="help-selection#" class="side-nav-li-a grey">Индивидуальные гиды</a>

                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#" class="side-nav-li-a grey">Отельеры</a>
                ...
                <div class="left-menu-1023__item">
                    ...
                    <div class="side-nav">
                        <ul class="side-nav-ul">
                            ...
                            <li class="side-nav-li">
                                <a href="help-selection#" class="side-nav-li-a ">Отдых с ТопХотелс</a>

                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#" class="side-nav-li-a ">Полезные фишки</a>

                            </li>
                            <li class="side-nav-li">
                                <a href="help-selection#" class="side-nav-li-a ">Все возможности</a>
                    ...
                    <div class="panel" id="confidentialityPanel" style="display: none">
                        <div class="agreement-pp__role-site">
                            ...
                            <div class="roles-wrapper">
                                ...
                                <p>Сайт <a href="help-selection#"> www.tophotels.ru </a> использует Вашу персональную информацию в следующих целях:
                                ...
                                <p>Сайт <a href="help-selection#">www.tophotels.ru</a> не дает в аренду, не продает и не делится Вашей персональной
                                    информацией с
                                ...
                                <p class="mb5">
                                    • Сайт <a href="help-selection#">www.tophotels.ru</a> может пользоваться услугами третьих лиц, помогающих в
                                ...
                                <p class="mb5"> • когда мы считаем, что передача информации может поспособствовать расследованию,
                                    ...
                                    Соглашения об условиях пользования ресурсом cайта <a href="help-selection#">www.tophotels.ru</a> или когда
                                    передача этой
                                    информации требуется по закону;</p>
                                <p class="mb10"> • мы можем передать информацию о Вас третьим лицам в том случае, если сайт
                                    <a href="help-selection#">www.tophotels.ru</a> будет приобретен или станет частью другой компании. В этом случае,
                                    сайт
                                    <a href="help-selection#">www.tophotels.ru</a> пришлет Вам соответствующее уведомление на адрес e-mail, указанный
                                    в вашем профиле
                                    на сайте <a href="help-selection#">www.tophotels.ru</a> , прежде чем другая Политика конфиденциальности вступит в
                                    силу по отношению
                                ...
                                <p>Сайт <a href="help-selection#">Сайт </a><a href="help-selection#">www.tophotels.ru </a> оставляет файлы cookies на Вашем компьютере и
                                    ...
                                    представляет собой небольшой объем информации, который серверы сайта <a href="help-selection#">www.tophotels.ru </a> переносят к
                                    ...
                                    просмотра некоторых секций сайта <a href="help-selection#">www.tophotels.ru </a> . Сайт <a href="help-selection#">www.tophotels.ru </a>
                                    ...
                                    политикой конфиденциальности, а не политикой конфиденциальности сайта <a href="help-selection#">www.tophotels.ru </a> . Другие
                                    компании не могут получить доступ к файлам cookies сайта <a href="help-selection#">www.tophotels.ru </a> .
                                ...
                                <p>Сайт <a href="help-selection#">www.tophotels.ru </a> предоставляет ссылки на третьи сайты и может информировать
                                    пользователей о
